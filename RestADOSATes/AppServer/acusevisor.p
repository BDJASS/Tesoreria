...
FOR EACH Acuse WHERE Acuse.FecOper  >= l-fecdepini 
    ...
    FOR EACH PagoAcuse OF Acuse WHERE (IF IdTipoPago <> 0 AND IdTipoPago <> ? THEN PagoAcuse.Id-Tp = IdTipoPago ELSE TRUE) NO-LOCK:                         
        ...
        IF AVAILABLE TipoPago AND PagoAcuse.Id-Tp <> 50 THEN DO:
            ...
            // Busco si es un anticipo
            IF NOT AVAILABLE DepBanco AND Acuse.Tipo = 'A' THEN DO:
                ...
                IF AVAILABLE bf-acuse THEN DO:
                    ...
                    IF AVAILABLE DepBanco THEN DO:
                        ...
                        IF AVAILABLE bf-pagoacuse AND (DepBanco.Importe - PagoAcuse.Importe = bf-pagoacuse.importe) THEN DO: 
            ...
            ASSIGN 
                ...
                ttAcuse.NomUsuario  = Usuario.Nom-Usuario WHEN AVAILABLE Usuario
                ttAcuse.FecCanc     = Acuse.FecCanc
                ttAcuse.UsrCan      = Acuse.UsuarioCanc
                ttAcuse.SolCanc     = Acuse.UsuarioSol
                ttAcuse.MotivoCanc  = Acuse.Motivo.
